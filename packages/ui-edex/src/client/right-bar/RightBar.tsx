...
import { RecoveryWidget } from '../left-bar/widgets/RecoveryWidget.tsx'
...
const RIGHT_WIDGETS: RightWidgetSlot[] = [
  ...
  // Featured: RECOVERY SEQUENCE TIMELINE replaces WORLD VIEW globe.
  { id: 'globe', title: 'RECOVERY SEQUENCE', fill: true, Component: RecoveryWidget },
