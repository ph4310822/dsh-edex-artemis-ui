...
import { RecoveryWidget } from './widgets/RecoveryWidget.tsx'
...
const LEFT_WIDGETS: LeftWidgetSlot[] = [
  ...
  // Flex-fills the leftover bar height so the timeline runs into the footer.
  { id: 'processes', title: 'RECOVERY SEQUENCE', fill: true, Component: RecoveryWidget },
]
